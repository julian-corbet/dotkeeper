...
func TestMutagenEnsurePeerCreatesSession(t *testing.T) {
	...
	if !strings.Contains(joined, "alice@192.0.2.10:") {
		t.Errorf("args = %v, expected SSH target alice@192.0.2.10", cmd.args)
	}
